...
class _AddPurchaseScreenState extends State<AddPurchaseScreen> {
    ...
    return Scaffold(
      ...
      floatingActionButton: isDesktop
          ? FloatingActionButton.extended(
              ...
              backgroundColor: _controller.canSave
                  ? theme.highlight
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Total display
                        _TotalCard(
                            total: _controller.formattedTotal, theme: theme),
                            ...
                            Container(
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [
                                    theme.highlight,
                                    theme.highlight.withOpacity(0.85)
                                  ],
  ...
  InputDecoration _dialogInputDecoration(
      ThemeProvider theme, String label, IconData icon,
  ...
  void _showAddItemDialog({int? productId}) {
    ...
    if (selectedProductId != null) {
      final p = _controller.products
          .firstWhere((x) => x['id'] == selectedProductId, orElse: () => {});
      if (p.isNotEmpty) {
        ...
        if (stocks.isNotEmpty) {
          ...
          currWholesale =
              (latestStock['wholesale_price'] as num? ?? 0).toDouble();
                      ...
                      if (!isManualEntry) ...[
                                                ...
                                                if (p.isNotEmpty) {
                                                  setDialogState(() {
                                                    ...
                                                    if (stocks.isNotEmpty) {
                                                      final latestStock =
                                                          stocks.last;
                                                      currCost = (latestStock[
                                                                      'cost_price']
                                                                  as num? ??
                                                              0)
                                                          .toDouble();
                                                      currWholesale =
                                                          (latestStock['wholesale_price']
                                                                      as num? ??
                                                                  0)
                                                              .toDouble();
                                                      currPrice = (latestStock[
                                                                      'sale_price']
                                                                  as num? ??
                                                              0)
                                                          .toDouble();
                                                    ...
                                                    costCtrl.text = currCost
                                                        .toStringAsFixed(2);
                                                    wholesaleCtrl.text =
                                                        currWholesale
                                                            .toStringAsFixed(2);
                                                    priceCtrl.text = currPrice
                                                        .toStringAsFixed(2);
                                                  });
                                                }
                                              }
                                              ...
                                              setDialogState(() {
                                                ...
                                                if (stocks.isNotEmpty) {
                                                  final latestStock =
                                                      stocks.last;
                                                  currCost =
                                                      (latestStock['cost_price']
                                                                  as num? ??
                                                              0)
                                                          .toDouble();
                                                  currWholesale = (latestStock[
                                                                  'wholesale_price']
                                                              as num? ??
                                                          0)
                                                      .toDouble();
                                                  currPrice =
                                                      (latestStock['sale_price']
                                                                  as num? ??
                                                              0)
                                                          .toDouble();
                                                  stock =
                        ...
                        TextField(
                          ...
                          decoration: _dialogInputDecoration(
                              theme, 'Product Name', Icons.edit_note_rounded,
                              isRequired: true),
                          style: TextStyle(
                              color: theme.textPrimary,
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                              ...
                              decoration: _dialogInputDecoration(theme,
                                  'Stock Quantity', Icons.numbers_rounded,
                                  isRequired: true),
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              onChanged: (_) => setDialogState(() {}),
                              decoration: _dialogInputDecoration(theme,
                                  'Cost Price', Icons.attach_money_rounded,
                                  isRequired: true),
                              style: TextStyle(color: theme.textPrimary),
                            ),
                          ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              onChanged: (_) => setDialogState(() {}),
                              decoration: _dialogInputDecoration(theme,
                                  'Sale Price', Icons.price_change_rounded,
                                  isRequired: true),
                              style: TextStyle(color: theme.textPrimary),
                            ),
                          ),
                                ...
                                onTap: () {
                                  ...
                                  final pCost =
                                      double.tryParse(costCtrl.text.trim()) ??
                                          0;
                                  final pieces =
                                      double.tryParse(piecesCtrl.text.trim()) ??
                                          1.0;
                                  ...
                                  if (name.isEmpty || qty <= 0 || pCost <= 0) {
                                    ScaffoldMessenger.of(ctx).showSnackBar(
                                      const SnackBar(
                                          content: Text(
                                              'Please enter valid name, quantity and cost')),
                                    );
                                    return;
                                  }
                                  ...
                                  _controller.addItem(
                                    ...
                                    barcode: selectedProductId != null
                                        ? _controller.products.firstWhere((x) =>
                                                x['id'] ==
                                                selectedProductId)['barcode']
                                            as String?
                                        : null,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: theme.glassDecoration.copyWith(
        gradient: LinearGradient(
          colors: [
            theme.highlight.withOpacity(0.2),
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration:
                BoxDecoration(color: theme.highlight, shape: BoxShape.circle),
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: DropdownButtonFormField<int>(
                  ...
                  decoration: theme.glassInputDecoration(
                      'Supplier', Icons.business_rounded,
                      isRequired: true),
              ...
              Container(
                ...
                child: IconButton(
                  icon:
                      Icon(Icons.add_rounded, color: theme.highlight, size: 22),
              ...
              Expanded(
                child: DropdownButtonFormField<int>(
                  ...
                  style: TextStyle(
                      ...
                      fontSize: 13),
                  decoration: theme.glassInputDecoration(
                      'Product', Icons.inventory_rounded),
            ...
            Align(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(ThemeProvider.radiusList),
                  border:
                      Border.all(color: ThemeProvider.error.withOpacity(0.2)),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.account_balance_wallet_rounded,
                        color: ThemeProvider.error, size: 14),
                    const SizedBox(width: 8),
                    Text(
              ...
              Expanded(
                child: TextFormField(
                  ...
                  validator: (v) {
                    ...
                    if (controller.isInvoiceDuplicate)
          ...
          DropdownButtonFormField<String>(
            ...
            style: TextStyle(
                color: theme.textPrimary, fontWeight: FontWeight.w600),
            decoration: theme.glassInputDecoration(
                'Payment Type', Icons.payment_rounded),
          ...
          if (controller.paymentType == 'Cheque') ...[
            ...
            TextField(
                ...
                style: TextStyle(
                    color: theme.textPrimary, fontWeight: FontWeight.w600),
                decoration: theme.glassInputDecoration(
                    'Cheque Number', Icons.confirmation_number_rounded)),
            ...
            TextField(
                ...
                style: TextStyle(
                    color: theme.textPrimary, fontWeight: FontWeight.w600),
                decoration: theme.glassInputDecoration(
                    'Transaction Reference', Icons.receipt_long_rounded)),
          ],
          const SizedBox(height: 16),
          ...
          TextField(
            ...
            keyboardType: TextInputType.number,
            style: TextStyle(
                color: controller.paymentType == 'Partial'
                    ? theme.textPrimary
                    : theme.textSecondary,
                fontWeight: FontWeight.w600),
            ...
            child: Column(
              children: [
                ...
                _SummaryRow(
                    label: 'Paid',
                    value:
                        '${BusinessConfig.instance.currency}. ${controller.paidAmount.toStringAsFixed(2)}',
                    theme: theme),
                const Divider(height: 24, color: Colors.white10),
                _SummaryRow(
                  label: 'To Balance',
                  value:
                      '${BusinessConfig.instance.currency}. ${controller.creditAmount.toStringAsFixed(2)}',
                  theme: theme,
                  valueColor: controller.creditAmount > 0
                      ? ThemeProvider.error
                ...
                _SummaryRow(
                  label: 'New Balance',
                  value:
                      '${BusinessConfig.instance.currency}. ${controller.newBalance.toStringAsFixed(2)}',
                  theme: theme,
                  isItalic: true,
                ),
              ],
          ...
          TextField(
              ...
              maxLines: 2,
              decoration:
                  theme.glassInputDecoration('Notes', Icons.note_rounded)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: ListTile(
        ...
        title: Text(item['product_name'] ?? 'Unknown',
            style: TextStyle(
                color: theme.textPrimary, fontWeight: FontWeight.w800)),
        subtitle: Padding(
...
class _SaveButton extends StatelessWidget {
  ...
  const _SaveButton(
      {required this.theme, this.onPressed, this.total, this.previous});
  @override
  Widget build(BuildContext context) {
...
class _ProductStats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textColor = isDialog ? const Color(0xFF1F2937) : theme.textPrimary;
    final labelColor = isDialog ? const Color(0xFF6B7280) : theme.textSecondary;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildMiniStat('Current Cost',
              '$currency. ${cost.toStringAsFixed(2)}', labelColor, textColor),
        ],
      ),
    );
  }
  ...
  Widget _buildMiniStat(
    ...
    return Row(
      ...
      children: [
        Text(label,
            style: TextStyle(
                color: labelColor, fontSize: 13, fontWeight: FontWeight.w600)),
        Text(value,
            style: TextStyle(
