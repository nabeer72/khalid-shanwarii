            ...
            children: [
              TextField(
                ...
                decoration: theme.glassInputDecoration(
                    'Type Name (e.g. Cash, Card)', Icons.payments_rounded),
              ...
              TextField(
                controller: codeCtrl,
                decoration: theme.glassInputDecoration(
                    'Code (e.g. cash, card)', Icons.code_rounded),
  ...
  Future<void> _deletePT(dynamic id) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content:
            const Text('Are you sure you want to delete this payment type?'),
        actions: [
          TextButton(
